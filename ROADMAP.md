...
- **Remaining tool (later milestone):** text (predefined style set) — the last tool of the original set still unbuilt, and the only one needing a new dependency.
- **Destructive ops (later milestones):** crop, blur, pixelate
