...
- **Full tool set (later milestones):** arrow, line, rectangle (with fill toggle), ellipse (with fill toggle), freehand pencil with auto-smoothing, highlighter, text (predefined style set)
